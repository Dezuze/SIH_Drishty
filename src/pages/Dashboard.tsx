...
import { LocationPoint, RouteMetrics, ClusterInfo, ActivityEvent } from '../types/dashboardTypes';
  ...
  const handleOptimizeRoute = () => {
    ...
    setTimeout(() => {
      ...
      const newAct: ActivityEvent = {
        ...
        description: 'Multi-stop sequence computed: Farm Hub ΓåÆ Cust A ΓåÆ Cust B ΓåÆ Cust C (24.6 km, 52 min).',
        type: 'route',
        badge: 'Optimized',
      };
