...
export const Marketplace: React.FC<MarketplaceProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-950 via-slate-900 to-slate-950 text-slate-900 pt-8 pb-14 px-4 sm:px-6 lg:px-8 border-b border-emerald-500/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4 text-left">
              ...
              <div className="grid grid-cols-3 gap-3 pt-2 max-w-md">
                <div className="bg-white/80 backdrop-blur-xs border border-slate-200 rounded-xl p-3 text-left">
                  <Truck className="w-5 h-5 text-emerald-400 mb-1" />
                  <p className="text-xs font-bold text-slate-900">Harvest to Home</p>
                  <p className="text-[11px] text-slate-600">Within 24 Hours</p>
                </div>
                <div className="bg-white/80 backdrop-blur-xs border border-slate-200 rounded-xl p-3 text-left">
                  <ShieldCheck className="w-5 h-5 text-emerald-400 mb-1" />
                  <p className="text-xs font-bold text-slate-900">100% Direct</p>
                  <p className="text-[11px] text-slate-600">Zero Commissions</p>
                </div>
                <div className="bg-white/80 backdrop-blur-xs border border-slate-200 rounded-xl p-3 text-left">
                  <Users className="w-5 h-5 text-emerald-400 mb-1" />
                  <p className="text-xs font-bold text-slate-900">50+ Farmers</p>
                  <p className="text-[11px] text-slate-600">Kochi & Thrissur</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 hidden lg:block">
              <div className="bg-white/90 backdrop-blur-md border border-emerald-500/30 rounded-3xl p-6 shadow-2xl space-y-4">
                ...
                <div className="flex items-center gap-4 bg-slate-50/80 p-3 rounded-2xl border border-slate-200">
                  <img
                  ...
                  />
                  <div>
                    <h4 className="text-lg font-bold text-slate-900">Organic Red Tomatoes</h4>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 relative z-20">
        ...
        <div className="bg-white/95 rounded-3xl p-4 sm:p-6 shadow-xl border border-slate-200 mb-8 backdrop-blur-md">
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
            ...
            <div className="relative flex-1">
              <input
                ...
                className="w-full pl-11 pr-10 py-3 bg-slate-50 hover:bg-white focus:bg-slate-50 border border-slate-300 rounded-2xl text-sm text-slate-900 placeholder-slate-400 focus:outline-hidden focus:border-emerald-500 focus:ring-3 focus:ring-emerald-500/20 transition-all"
              />
              <Search className="absolute left-3.5 top-3.5 w-4 h-4 text-slate-600" />
              {searchQuery && (
                <button
                  onClick={() => onSearchChange('')}
                  className="absolute right-3.5 top-3.5 text-xs text-slate-600 hover:text-slate-900 bg-slate-100 px-2 py-0.5 rounded-full"
                >
                  Clear
                </button>
              )}
            ...
            <div className="flex items-center gap-2 self-end md:self-auto shrink-0">
              <div className="flex items-center gap-2 bg-slate-50 border border-slate-300 px-3.5 py-2.5 rounded-2xl text-xs font-semibold text-slate-700">
                ...
                >
                  <option value="featured" className="bg-white text-slate-900">Featured / Newest</option>
                  ...
                  <option value="availability" className="bg-white text-slate-900">Highest Stock</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mb-6 px-1">
          <div className="flex items-center gap-2">
            <h2 className="text-xl font-black text-slate-900">Available Farm Products</h2>
        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-white/90 rounded-3xl border border-slate-200 p-12 text-center max-w-lg mx-auto shadow-xl">
            <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto text-slate-600 mb-4">
              <Search className="w-8 h-8" />
            </div>
            <h3 className="text-lg font-bold text-slate-900 mb-1">No farm products found</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product) => (
              <div
                ...
                className="group bg-white/90 rounded-3xl overflow-hidden border border-slate-200 hover:border-emerald-500/50 shadow-lg hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-300 flex flex-col cursor-pointer"
              >
                ...
                <div className="relative aspect-4/3 overflow-hidden bg-slate-50">
                  ...
                  <div className="absolute bottom-3 left-3 bg-slate-50/85 text-slate-900 text-[11px] font-semibold px-2.5 py-1 rounded-lg backdrop-blur-xs flex items-center gap-1 border border-slate-200">
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <h3 className="text-lg font-bold text-slate-900 group-hover:text-emerald-300 transition-colors">
                        {product.name}
                      </h3>
