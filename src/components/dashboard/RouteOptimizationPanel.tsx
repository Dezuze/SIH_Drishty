    ...
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-slate-900 to-slate-950 border border-emerald-500/40 p-5 shadow-2xl">
        ...
        <div className="flex items-center p-1 bg-slate-50 rounded-xl border border-slate-200 text-xs">
          <button
            ...
            className={`px-3 py-1 rounded-lg font-semibold transition ${
              activeTab === 'comparison' ? 'bg-emerald-950 text-emerald-300 border border-emerald-500/40' : 'text-slate-600 hover:text-white'
            }`}
          >
            Route Comparison
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-lg font-semibold transition ${
              activeTab === 'algorithm' ? 'bg-emerald-950 text-emerald-300 border border-emerald-500/40' : 'text-slate-600 hover:text-white'
            }`}
          >
            AI Solver Pipeline
          </button>
      ...
      {showSuccessToast && (
        <div className="my-4 p-3.5 rounded-2xl bg-gradient-to-r from-emerald-950 via-emerald-900 to-teal-950 border border-emerald-400/60 shadow-xl flex items-center justify-between gap-3 animate-fadeIn">
          ...
          <button
            ...
            className="text-xs text-emerald-300 hover:text-slate-900 underline font-semibold px-2 py-1"
          >
            Dismiss
          </button>
        </div>
      ...
      {activeTab === 'comparison' ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 my-4">
          ...
          <div className="p-4 rounded-2xl bg-slate-50/60 border border-slate-200 text-xs">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="font-mono font-bold text-slate-700">{metrics.unoptimizedDistanceKm} km</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Est. Travel Time:</span>
                <span className="font-mono font-bold text-slate-700">{metrics.unoptimizedTimeMin} min</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Sequence:</span>
                <span className="text-slate-600 font-mono">Farm G�� C G�� A G�� B (Zigzag)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Perishability Risk:</span>
          ...
          <div className="p-4 rounded-2xl bg-emerald-950/30 border border-emerald-500/50 text-xs relative overflow-hidden">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                <span className="text-slate-700">Est. Travel Time:</span>
              ...
              <div className="flex justify-between">
                <span className="text-slate-700">Optimized Order:</span>
                <span className="text-emerald-300 font-mono font-semibold">Farm G�� A G�� B G�� C</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-700">Fuel & Carbon Saving:</span>
        ...
        <div className="my-4 p-4 rounded-2xl bg-slate-50/80 border border-slate-200 text-xs space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
            <div className="p-2.5 rounded-xl bg-white border border-slate-200">
              <span className="text-[10px] text-emerald-400 font-bold block mb-1">STAGE 1</span>
              <p className="font-semibold text-slate-900">Cluster Discovery</p>
              <p className="text-[11px] text-slate-600 mt-0.5">DBSCAN algorithm grouped 3 nearby orders in 3.4km radius.</p>
            </div>
            <div className="p-2.5 rounded-xl bg-white border border-slate-200">
              <span className="text-[10px] text-emerald-400 font-bold block mb-1">STAGE 2</span>
              <p className="font-semibold text-slate-900">Capacity & Payload</p>
              <p className="text-[11px] text-slate-600 mt-0.5">85 kg verified against 150 kg vehicle payload capacity.</p>
            </div>
            <div className="p-2.5 rounded-xl bg-white border border-slate-200">
              <span className="text-[10px] text-emerald-400 font-bold block mb-1">STAGE 3</span>
              <p className="font-semibold text-slate-900">Shelf-Life Priority</p>
              <p className="text-[11px] text-slate-600 mt-0.5">Prioritized high-respiration tomatoes and fresh bell peppers.</p>
            </div>
            <div className="p-2.5 rounded-xl bg-white border border-slate-200">
              <span className="text-[10px] text-emerald-400 font-bold block mb-1">STAGE 4</span>
              <p className="font-semibold text-slate-900">TSP Matrix Solver</p>
              <p className="text-[11px] text-slate-600 mt-0.5">Calculated lowest-mileage corridor (24.6 km).</p>
            </div>
          </div>
        </div>
      )}
