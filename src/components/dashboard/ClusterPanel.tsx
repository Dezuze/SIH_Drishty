    ...
    <div className="rounded-3xl bg-white/90 border border-slate-200 p-5 shadow-xl flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2.5 my-4">
          ...
          {/* Number of Orders */}
          <div className="p-3 rounded-2xl bg-slate-50/70 border border-slate-200/80 hover:border-slate-300 transition">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[11px] text-slate-600">Orders</span>
            </div>
          </div>
              ...
              <div
                ...
                className={`p-3 rounded-2xl border transition-all duration-200 cursor-pointer ${
                  isSelected 
                    ...
                    : 'bg-slate-50/50 border-slate-200/90 hover:bg-slate-100/50 hover:border-slate-300'
                }`}
              >
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className={`w-8 h-8 rounded-xl flex items-center justify-center font-extrabold text-xs shadow-md shrink-0 ${
                      simStatus === 'Delivered'
                        ...
                        : isSelected
                        ? 'bg-emerald-500 text-slate-950 ring-2 ring-emerald-400'
                        : 'bg-slate-100 text-emerald-300 border border-slate-300'
                    }`}>
                ...
                <div className="mt-2.5 pt-2 border-t border-slate-200/80 flex items-center justify-between text-[11px] text-slate-600">
                  <span className="flex items-center gap-1">
                    ...
                    Window: <strong className="text-slate-700 font-medium">{cust.deliveryWindow}</strong>
                  </span>
