    ...
    <div className="rounded-3xl bg-white/90 border border-slate-200 p-5 shadow-xl flex flex-col justify-between">
      ...
      <div>
        ...
        <div className="flex items-center justify-between pb-3.5 border-b border-slate-200">
          ...
          <div className="text-right">
            ...
            <span className="text-[10px] text-slate-600 block">Clear & Dry</span>
          </div>
        </div>

        {/* Weather Metrics Grid */}
        <div className="grid grid-cols-3 gap-2 my-3.5">
          <div className="p-2 rounded-xl bg-slate-50/60 border border-slate-200/80 text-center">
            <span className="text-[10px] text-slate-600 flex items-center justify-center gap-1">
              <Droplets className="w-3 h-3 text-blue-400" />
              Humidity
            </span>
            <span className="font-bold text-xs text-slate-900 font-mono mt-0.5 block">{weather.humidityPercent}%</span>
          </div>
          ...
          <div className="p-2 rounded-xl bg-slate-50/60 border border-slate-200/80 text-center">
            ...
            <span className="font-bold text-xs text-slate-900 font-mono mt-0.5 block">{weather.windSpeedKmh} km/h</span>
          </div>
        ...
        <div className="p-3.5 rounded-2xl bg-gradient-to-r from-emerald-950/60 to-teal-950/60 border border-emerald-500/30">
          ...
          <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
            <div>
              <span className="text-[10px] text-slate-600 block">Fuel Saved</span>
              <span className="font-mono font-bold text-slate-900">{metrics.fuelSavedLitres} Litres (G�{metrics.costSavedInr})</span>
            </div>
            <div>
              <span className="text-[10px] text-slate-600 block">Carbon Offset</span>
              <span className="font-mono font-bold text-emerald-400">{metrics.co2SavedKg} kg COG�� eq.</span>
            </div>
          </div>
        </div>
      ...
      <div className="mt-3.5 pt-3 border-t border-slate-200 flex items-center justify-between text-xs text-slate-600">
        <span className="flex items-center gap-1">
          ...
          Road Surface: <strong className="text-slate-900">Dry & Optimal</strong>
        </span>
