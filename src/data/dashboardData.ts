...
export const INITIAL_ACTIVITIES: ActivityEvent[] = [
  ...
  },
  {
    ...
    description: 'Sequence: Farm Hub ΓåÆ Anita (Cust A) ΓåÆ Rajesh (Cust B) ΓåÆ Deepa (Cust C). Saved 9.6 km.',
    type: 'route',
    badge: 'AI Optimized',
  },
  {
    id: 'act-4',
    timestamp: '06:35 AM',
    title: 'Driver αñ░αñ╛αñ£αÑçαñ╢ Kumar Assigned & Manifest Dispatched',
